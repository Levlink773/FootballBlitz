...
class TrainingReminder:
    ...
    MESSAGES = {
        3: [
            "🏃‍♂️ {name} не тренувався 3 години. Невелике нагадування: тренування — шлях до перемоги!",
            "⏱️ Минуло 3 години з останнього тренування {name}. Пора розім'ятись!",
        ],
        6: [
            "🔥 {name} не тренувався вже 6 годин. Поверніться на тренування — команда чекає!",
            "⚽ {name} просить тренування! Не забувай робити щоденні вправи.",
        ],
        12: [
            "⚠️ Пройшло 12 годин без тренувань для {name}. Не давайте формі падати!",
            "🏅 12 годин без тренувань. Час повернутись і підтягнути результати!"
        ],
        24: [
            "🎁 Минуло 24 години — за старанність ми даруємо подарунок для {name}!",
            "🎉 Ти довго не тренувався — ось невеликий подарунок за повернення на поле!"
        ]
    }
