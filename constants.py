...
TIME_RESET_ENERGY_CHARACTER = CronTrigger(hour=3, minute=0)
...
MENU_TEAM = FSInputFile('src/menu_team.png')
RATING = FSInputFile('src/rating.png')
BALANCE = FSInputFile('src/balance.png')
RECORNATION = FSInputFile('src/recornation.png')
