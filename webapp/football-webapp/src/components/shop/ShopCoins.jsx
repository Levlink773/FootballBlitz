...
function ShopCard({ title, price, image }) {
    const baseStyle = {
        ...
        height: 190,
        borderRadius: 16,
        backgroundImage: `url(${Config.IMAGES.gold_coin})`,
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.grid}>
                <ShopCard title="100 монет" price="125 грн" image={Config.IMAGES.coin_mini} />
                <ShopCard title="500 монет" price="200 грн" image={Config.IMAGES.coin_medium} />
                <ShopCard title="1'000 монет" price="350 грн" image={Config.IMAGES.coin_large} />
                <ShopCard title="10'000 монет" price="2500 грн" image={Config.IMAGES.coin_premium} />
            </div>
        </div>
    );
}
