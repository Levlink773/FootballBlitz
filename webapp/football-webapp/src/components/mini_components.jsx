...
export const AgeIconMini = ({ className, size, style }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        xmlSpace="preserve"
        // 🛠️ ВИПРАВЛЕНО: Використовуємо size або 100%
    ...
    >
        ...
        <g id="Layer_x0020_1">
            ...
            {/* Виправлено помилку 'classNameclassName' на 'className' */}
            <path className="fil3"
