        ...
        const updateUserStatus = async () => {
            ...
            if (user?.status_register === 'TRANSFER') {
                try {
                    ...
                    const msg = `
🔹 Тренер:
Трансферний ринок — місце, де ти керуєш складом і заробляєш монети. Можеш продати гравця на ринку або придбати вільних агентів.
Порада: якщо тобі потрібні швидкі кошти — вибирай «Продати миттєво». Якщо хочеш виторгувати більше — виставляй на аукціон/ринок і чекай покупця.
Тепер переходимо до магазину речей – тисни іконку магазина в правому верхньому кутку.
                    `;
                    showInfoModal({
