...
const inputFile = path.resolve(__dirname, "components", "modal_components", "VipModal.jsx");
const outputFile = path.resolve(__dirname, "components","modal_components", "VipModal.jsx");
