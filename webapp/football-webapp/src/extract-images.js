...
const inputFile = path.resolve(__dirname, "components", "training", "TrainingOption.jsx");
const outputFile = path.resolve(__dirname, "components","training", "TrainingOption.jsx");
